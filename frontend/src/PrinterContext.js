          ...
          <div className="bg-white rounded-xl p-6 max-w-md w-full">
            ...
            <div className="space-y-4">
              ...
              <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
                {printerType === 'webusb' ? (
                  <>
                    <div className="font-medium mb-1">WebUSB Requirements:</div>
                  ...
                  <>
                    <div className="font-medium mb-1">Star WebPRNT Requirements:</div>
                    <ul className="list-disc list-inside space-y-1 mb-3">
                      <li>Download & install Star WebPRNT Browser</li>
                      <li>Configure TSP III in WebPRNT Browser</li>
                      <li>Start WebPRNT Browser service</li>
                      <li>Any modern web browser</li>
                    </ul>
                    
                    <div className="font-medium mb-1">Setup Steps:</div>
                    <ol className="list-decimal list-inside space-y-1 text-xs">
                      <li>Download Star WebPRNT Browser from Star Micronics</li>
                      <li>Install and configure your TSP III printer</li>
                      <li>Start the WebPRNT Browser application</li>
